...
#Headings
heading1 = tk.Label(left_frame, text="Admin panel", font=("Roboto", 24), bg="#D9D9D9", fg="#000000", justify="center")
...
heading3 = tk.Label(left_frame, text="Manage members", font=("Roboto", 24), bg="#D9D9D9", fg="#000000", justify="center")
heading3.place(x=25, y=180, width=500, height=50)


#TABLE

table = ttk.Treeview(left_frame, columns=("Member ID", "Name", "Email", "Edit"), show="headings", style="Custom.Treeview")
...
heading5 = tk.Label(right_frame, text="All members", font=("Roboto", 14), bg="#F0AFAF", fg="#000000", justify="center")
...
back_button = ttk.Button(left_frame, text="Back")
back_button.place(x=30, y=850, width=100, height=30)

add_member_button = ttk.Button(left_frame, text="Add member")
