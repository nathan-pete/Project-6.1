...
def login_admin_page():
    ...
    label.place(x=20, y=20, width=146, height=27)
    ...
    user_label = tk.Label(frame1, text="Username", font=("Inter", 18, "normal"), bg="#D9D9D9", fg="black", justify="left")
    ...
    login_button = tk.Button(frame1, text="Login", font=("Inter", 12), bg="#D9D9D9", fg="black",
    ...
    login_button = tk.Button(frame1, text="Back", font=("Inter", 12), bg="#D9D9D9", fg="black",
                             bd=0, highlightthickness=0, activebackground="#B3B3B3",
